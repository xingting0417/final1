    ...
    update(roadBorders,target){
        ...
        if(!this.damaged){
            ...
            if(this.reachedTarget){
                ...
                if (currentIndex !== -1 && currentIndex + 1 < targets.length) {
                    // Set the next target as the target
                    this.target = targets[currentIndex + 1];
                    this.reachedTarget = false; // Reset reachedTarget flag
                }
            }
        }
